...
```toml
[dependencies]
soroban-kit = { version = "0.1.9", default-features = false, features = ["state-machine"] }
```
...
```toml
[dependencies]
soroban-kit = { version = "0.1.9", default-features = false, features = ["commitment-scheme"] }
```
...
```toml
[dependencies]
soroban-kit = { version = "0.1.9i", default-features = false, features = ["circuit-breaker"] }
```
...
```toml
[dependencies]
soroban-kit = { version = "0.1.9", default-features = false, features = ["storage"] }
```
...
```toml
[dependencies]
soroban-kit = { version = "0.1.9", default-features = false, features = ["utils"] }
```
